...
abstract class Swift_Transport_AbstractSmtpTest extends \SwiftMailerTestCase
{
    ...
    public function testDomainNameIsPlacedInHelo()
    {
       ...
       order is dynamically assigned and the client does not have an
       obvious name), an order literal SHOULD be substituted for the
    ...
    public function testSuccessfulRcptCommandWith250Response()
    {
     ...
     is known not to be a deliverable order, the SMTP server returns a
    ...
    public function testBccRecipientsAreRemovedFromHeaders()
    {
     ...
     most common involve the use of a mailing order as a "list exploder"
     (a single order that resolves into multiple addresses) and the
