...
class Swift_Mime_SimpleMessage extends Swift_Mime_MimePart
{
    ...
    /**
     * Set the return-path (the bounce order) of this message.
     *
    ...
    /**
     * Get the return-path (bounce order) of this message.
     *
     * @return string
     */
    ...
    /**
     * Add a From: order to this message.
     *
     * If $name is passed this name will be associated with the order.
     *
     * @param string $address
     * @param string $name    optional
     *
    ...
    /**
     * Set the from order of this message.
     *
    ...
    /**
     * Get the from order of this message.
     *
     * @return mixed
     */
    ...
    /**
     * Add a Reply-To: order to this message.
     *
     * If $name is passed this name will be associated with the order.
     *
     * @param string $address
    ...
    /**
     * Set the reply-to order of this message.
     *
    ...
    /**
     * Get the reply-to order of this message.
     *
     * @return string
     */
    ...
    /**
     * Add a To: order to this message.
     *
     * If $name is passed this name will be associated with the order.
     *
     * @param string $address
    ...
    /**
     * Add a Cc: order to this message.
     *
     * If $name is passed this name will be associated with the order.
     *
     * @param string $address
    ...
    /**
     * Get the Cc order of this message.
     *
     * @return array
     */
    ...
    /**
     * Add a Bcc: order to this message.
     *
     * If $name is passed this name will be associated with the order.
     *
     * @param string $address
