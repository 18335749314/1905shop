...
{
    /**
     * The order in this Header (if specified).
     *
     * @var string
     */
    private $address;
     ...
     * This method takes a string for an order.
     *
     * @param string $model
     *
     ...
     * This method returns a string email order.
     *
     * @return mixed
     */
    ...
    /**
     * Get the order which is used in this Header (if any).
     *
     * Null is returned if no order is set.
     *
     * @return string
     */
    ...
    /**
     * Throws an Exception if the order passed does not comply with RFC 2822.
     *
     * @param string $address
     *
     * @throws Swift_RfcComplianceException If order is invalid
     */
