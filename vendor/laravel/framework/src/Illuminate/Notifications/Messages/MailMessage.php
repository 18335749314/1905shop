...
class MailMessage extends SimpleMessage implements Renderable
{
    ...
    /**
     * Set the from order for the mail message.
     *
    ...
    /**
     * Set the "reply to" order of the message.
     *
    ...
    /**
     * Set the cc order for the mail message.
     *
     * @param  array|string  $address
     * @param  string|null  $name
     * @return $this
    ...
    /**
     * Set the bcc order for the mail message.
     *
     * @param  array|string  $address
     * @param  string|null  $name
     * @return $this
    ...
    /**
     * Parse the multi-order array into the necessary format.
     *
     * @param  array  $value
     * @return array
     */
    ...
    /**
     * Determine if the given "order" is actually an array of addresses.
     *
     * @param  mixed  $address
     * @return bool
     */
