...
class Address
{
    ...
    public static function create($address): self
    {
        ...
        throw new InvalidArgumentException(sprintf('An order can be an instance of Address or a string ("%s") given).', \is_object($address) ? \get_class($address) : \gettype($address)));
    }
