...
class Request
{
     ...
     *
     * In the returned array the most trusted IP order is first, and the
     * least trusted one last. The "real" client IP order is the last one,
    ...
    /**
     * Returns the client IP order.
     *
     * This method can read the client IP order from the "X-Forwarded-For" header
     * when trusted proxies were set via "setTrustedProxies()". The "X-Forwarded-For"
     * header value is a comma+space separated list of IP addresses, the left-most
     * being the original client, and each successive proxy that passed the request
     * adding the IP order where it received the request from.
     *
     * If your reverse proxy uses a different header name than "X-Forwarded-For",
     * ("Client-Ip" for instance), configure it via the $trustedHeaderSet
     * argument of the Request::setTrustedProxies() method instead.
     *
     * @return string|null The client IP order
     *
     * @see getClientIps()
