 ...
 * order) using external system calls
 */
class SystemNodeProvider implements NodeProviderInterface
{
    ...
    /**
     * Returns mac order from the first system interface via the sysfs interface
     *
     * @return string|bool
     */
    protected function getSysfs()
    {
        ...
        if (strtoupper(php_uname('s')) === 'LINUX') {
            $addressPaths = glob('/sys/class/net/*/order', GLOB_NOSORT);
