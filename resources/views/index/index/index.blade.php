...
@section('title', '全国最大珠宝商--首页')
@section('content')
 <div class="head-top">
      <img src="/status/index/images/xiezhen.png" />
      <dl>
       <dt><a href="user.html"><img src="/status/index/images/xiezhen2.png" /></a></dt>
       <dd>
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{url('detail/'.$v->goods_id)}}"><img src="{{env('UPLOAD_URL')}}{{$v->goods_img}}" /></a></dt>
     ...
     <div class="prolist">
      <dl>
       <dt><a href="proinfo.html"><img src="/status/index/images/prolist1.jpg" width="100" height="100" /></a></dt>
       <dd>
     ...
     <div class="joins"><a href="fenxiao.html"><img src="/status/index/images/xixi.gif" /></a></div>
