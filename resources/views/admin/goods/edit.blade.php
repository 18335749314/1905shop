...
<body>
    ...
    <form class="form-horizontal" role="form" method="post" action="{{url('goods/store')}}" enctype="multipart/form-data">
		@csrf			<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="goods_name" id="form-field-1" value="{{$goodsInfo->goods_name}}" placeholder="商品名称" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="goods_price" id="form-field-2" value="{{$goodsInfo->goods_price}}" placeholder="商品价格" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="goods_num" id="form-field-5" value="{{$goodsInfo->goods_num}}" placeholder="商品库存" class="col-xs-10 col-sm-5" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<img src="{{env('UPLOAD_URL')}}{{$goodsInfo->goods_img}}" width="80" >
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea id="editor" name="goods_desc">{{$goodsInfo->goods_desc}}</textarea>
						</div>
					</div>
