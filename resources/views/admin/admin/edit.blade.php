...
<body>
    ...
    <form action="{{url('/admin/update/'.$date->admin_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
	@csrf
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name='admin_name' class="form-control" id="firstname"
				   placeholder="请输入账号" value="{{$date->admin_name}}">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name='admin_pwd' class="form-control" id="lastname"
				   placeholder="请输入密码" value="{{$date->admin_pwd}}">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name='admin_email' class="form-control" id="lastname"
				   placeholder="请输入邮箱" value="{{$date->admin_email}}">
