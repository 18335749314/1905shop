...
<body>
    ...
    <div class="page-content">
            <div class="row">
                    ...
                    <form action="{{url('/category/update/'.$date->cate_id)}}" method="post" class="form-horizontal" role="form" id="myform">
                    @csrf
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分类名称 </label>

                        <div class="col-sm-9">
                            <input type="text" name="cate_name" value="{{$date->cate_name}}" id="form-field-1" placeholder="分类名称" class="col-xs-10 col-sm-5" />
